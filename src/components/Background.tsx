...
void main(){
    ...
    gl_FragColor=vec4(clamp(col.rgb, 0.0, 1.0), uOpacity);
}
`;
...
export default function Background({
    ...
    useEffect(() => {
        ...
        const program = new Program(gl, {
            ...
            uniforms: {
                ...
                uWarp: { value: warpAmount || glitchAmount },
        ...
        const loop = () => {
            ...
            program.uniforms.uWarp.value = warpAmount || glitchAmount;
            program.uniforms.uTint.value.set(tint);
    ...
    }, [hueShift, noiseIntensity, scanlineIntensity, speed, scanlineFrequency, warpAmount, glitchAmount, resolutionScale, tint, opacity]);

    return (
        <div className="fixed inset-0 z-[-1] pointer-events-none w-screen h-screen overflow-hidden">
