...
export default function About() {
  ...
  let frontendTech: Tech[] = [
    ...
    { title: "Framer Motion", icon: <img alt="" draggable={false} className="h-6" src="/framer-motion.png" />, link: "https://www.framer.com/motion/" },
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-4 mt-4">
          ...
          >
            <AboutCard
              description={<>I’m a 15-year-old Developer & AI Engineer with a passion for technology and software development. At 13, I discovered Fortnite hacks, which sparked my curiosity in systems, software development and problem-solving. By 14, I launched my own service, earning $4,000, an early lesson in entrepreneurship.
                <br /><br />
