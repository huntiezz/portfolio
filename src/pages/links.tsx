  ...
  },
  {
    ...
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <path d="M4 6h16v12H4V6zm0 0l8 7 8-7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="square" />
      </svg>
    ),
  },
];
        ...
        {LINKS.map((item) => (
          <li key={item.href}>
            <Link
              ...
              className="flex items-center gap-4 py-4 text-lg lowercase tracking-wide text-foreground transition-colors hover:text-[color:var(--accent-blue)] sm:text-xl"
            >
